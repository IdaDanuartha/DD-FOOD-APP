...
<div class="xl:hidden block fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid h-full max-w-lg grid-cols-3 mx-auto">
        <a data-tooltip-target="tooltip-home" href="/home" class="inline-flex flex-col items-center justify-center px-5 rounded-l-full dark:hover:bg-gray-800 group">
        ...
        <a data-tooltip-target="tooltip-orders" href="/orders" class="inline-flex flex-col items-center justify-center px-5 dark:hover:bg-gray-800 group">
