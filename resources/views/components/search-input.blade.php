            ...
            <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
                <li>
                    <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                        <input id="filter-appetizer" type="radio" value="" name="filter-radio" class="w-4 h-4 text-main-color bg-gray-100 border-gray-300 focus:ring-main-color/80 dark:focus:ring-main-color/80 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <li>
                    <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                        <input id="filter-main-course" type="radio" value="" name="filter-radio" class="w-4 h-4 text-main-color bg-gray-100 border-gray-300 focus:ring-main-color/80 dark:focus:ring-main-color/80 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <li>
                    <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                        <input id="filter-dessert" type="radio" value="" name="filter-radio" class="w-4 h-4 text-main-color bg-gray-100 border-gray-300 focus:ring-main-color/80 dark:focus:ring-main-color/80 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="filter-dessert" class="w-full ml-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">Dessert</label>
                    </div>
                </li>
                <li>
                    <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                        <input id="filter-coffee" type="radio" value="" name="filter-radio" class="w-4 h-4 text-main-color bg-gray-100 border-gray-300 focus:ring-main-color/80 dark:focus:ring-main-color/80 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
